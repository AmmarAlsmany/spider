...
return new class extends Migration
{
    public function up()
    {
        Schema::create('visit_schedules', function (Blueprint $table) {
            ...
            $table->foreignId('branch_id')->nullable()->constrained('branchs')->onDelete('restrict')->onUpdate('cascade');
            $table->foreignId('team_id')->constrained('teams')->onDelete('restrict')->onUpdate('cascade');
