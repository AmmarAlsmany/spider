                ...
                <nav aria-label="breadcrumb">
                    <ol class="p-0 mb-0 breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('client.show') }}">{{ __('clients.contracts.my_contracts') }}</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">
                            {{ __('clients.contract_details.contract_number') }} {{ $contract->contract_number }}</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card radius-10">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0"><i
                                class="bx bx-calendar-check me-2"></i>{{ __('clients.contract_details.contract_details') }}
                        </h5>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <span>{{ __('clients.contract_details.start_date') }}</span>
                                        <strong>{{ \Carbon\Carbon::parse($contract->contract_start_date)->format('M d, Y') }}</strong>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <span>{{ __('clients.contract_details.end_date') }}</span>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <span>{{ __('clients.contract_details.status') }}</span>
                                        <span
        ...
        <div class="mt-4 card radius-10">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0"><i
                                class="bx bx-list-check me-2"></i>{{ __('clients.contract_visits.scheduled_visits') }}</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                                            ...
                                            <tbody>
                                                @foreach ($visits as $visit)
                                                    <tr>
                                                        ...
                                                        <td>{{ \Carbon\Carbon::parse($visit->visit_date)->format('M d, Y') }}
                                                        </td>
                                                        <td>{{ \Carbon\Carbon::parse($visit->visit_time)->format('h:i A') }}
                                                        </td>
                                                        <td>
                                                            <span
                                                                class="badge bg-{{ $visit->status == 'completed' ? 'success' : ($visit->status == 'scheduled' ? 'primary' : 'warning') }}">
                    ...
                    <form action="{{ route('client.visit.update') }}" method="POST">
                        ...
                        <div class="px-0 pb-0 modal-footer">
                            <button type="button" class="btn btn-secondary"
                                data-bs-dismiss="modal">{{ __('visits.edit_visit.cancel') }}</button>
