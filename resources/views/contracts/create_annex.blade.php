                ...
                <div class="shadow-sm card">
                    <div class="py-3 bg-white card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 text-primary"><i class="bx bx-file-plus me-2"></i>Create Contract Annex</h5>
                    ...
                    <div class="card-body">
                        <div class="mb-4 alert alert-info">
                            ...
                            Adding new branch and payment details to contract <strong>#{{ $contract->contract_number
                                }}</strong>
                        </div>

                        <form action="{{ route('contracts.annex.store', $contract->id) }}" method="post" id="annexForm">
                            @csrf
                            <div class="row g-4">
                                <!-- Branch Information -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <select class="form-select @error('branches.0.branch_city') is-invalid @enderror"
                                                                ...
                                                                <option value="{{ $city }}" {{ old('branches.0.branch_city') == $city ? 'selected' : '' }}>
                                                                    {{ $city }}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control @error('branches.0.branch_manager_phone') is-invalid @enderror"
                                                                    name="branches[0][branch_manager_phone]" placeholder="5XXXXXXXX" required
                                                                    pattern="[0-9]{9}" value="{{ old('branches.0.branch_manager_phone') }}">
                                                        ...
                                                        <div class="mb-3 col-12">
                                                            ...
                                                            <textarea class="form-control @error('branches.0.branch_address') is-invalid @enderror"
                                                                ...
                                                                rows="2">{{ old('branches.0.branch_address') }}</textarea>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror"
                                                    name="description" placeholder="Enter any additional notes or description"
                            ...
                            <div class="mt-4 text-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bx bx-check me-1"></i> Create Annex
                                </button>
                            </div>
                        </form>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const firstBranchRemoveBtn = document.querySelector('.branch-section[data-branch-index="0"] .remove-branch');
