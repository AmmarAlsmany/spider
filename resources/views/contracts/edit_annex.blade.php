                    ...
                    <div class="shadow-sm card">
                        <div class="py-3 bg-white card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="mb-0 text-primary"><i
                                        class="bx bx-edit me-2"></i>{{ __('contract_views.edit_annex') }}</h5>
                        ...
                        <div class="card-body">
                            <div class="mb-4 alert alert-info">
                                ...
                                Editing annex <strong>#{{ $annex->annex_number }}</strong> for contract
                            ...
                            <form action="{{ route('contracts.annex.update', $annex->id) }}" method="post" id="annexForm">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 col-md-6">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-control @error('branches.' . $index . '.branch_name') is-invalid @enderror"
                                                                ...
                                                                <div class="mb-3 col-md-6">
                                                                    <label class="form-label">Branch City <span
                                                                            class="text-danger">*</span></label>
                                                                    <select
                                                                        class="form-select @error('branches.' . $index . '.branch_city') is-invalid @enderror"
                                                                        name="branches[{{ $index }}][branch_city]"
                                                                        required>
                                                                        <option value="">Select City</option>
                                                                        @foreach ($saudiCities as $city)
                                                                            <option value="{{ $city }}"
                                                                                {{ old('branches.' . $index . '.branch_city', $branch->branch_city) == $city ? 'selected' : '' }}>
                                                                                {{ $city }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="mb-3 col-md-6">
                                                                    <label class="form-label">Branch Manager Name <span
                                                                            class="text-danger">*</span></label>
                                                                    <input type="text"
                                                                        class="form-control @error('branches.' . $index . '.branch_manager_name') is-invalid @enderror"
                                                                ...
                                                                <div class="mb-3 col-md-6">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text"
                                                                            class="form-control @error('branches.' . $index . '.branch_manager_phone') is-invalid @enderror"
                                                                            name="branches[{{ $index }}][branch_manager_phone]"
                                                                            placeholder="5XXXXXXXX" required
                                                                            pattern="[0-9]{9}"
                                                                            value="{{ old('branches.' . $index . '.branch_manager_phone', substr($branch->branch_manager_phone, 3)) }}">
                                                                        @error('branches.' . $index .
                                                                            '.branch_manager_phone')
                                                                            <div class="invalid-feedback">{{ $message }}
                                                                            </div>
                                                                        @enderror
                                                                    </div>
                                                                    <small class="text-muted">Enter 9 digits without the
                                                                        country code</small>
                                                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="border-0 shadow-sm card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="mb-3 col-md-6">
                                                        <label class="form-label">Additional Amount <span
                                                                class="text-danger">*</span></label>
                                                        <div class="input-group">
                                                            <span class="input-group-text">SAR</span>
                                                            <input type="number"
                                                                class="form-control @error('additional_amount') is-invalid @enderror"
                                                                name="additional_amount" placeholder="Enter amount"
                                ...
                                <div class="mt-4 text-end">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bx bx-save me-1"></i> {{ __('contract_views.save') }}
                                    </button>
                                </div>
                            </form>
                        </div>
