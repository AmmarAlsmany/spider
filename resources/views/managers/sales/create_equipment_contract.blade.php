...
<div class="page-content">
    ...
    <div class="mb-4 page-breadcrumb d-flex align-items-center">
        <div class="pe-3 breadcrumb-title d-flex align-items-center">
            ...
            <h4 class="mb-0 text-primary"><i class="bx bx-file-plus"></i> {{ __('sales_views.create_equipment_contract')
                }}</h4>
        </div>
        <div class="ps-3">
                    ...
                    <form action="{{ route('equipment.contract.store') }}" method="POST" id="contractForm">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <label for="client_id" class="form-label">{{
                                        __('sales_views.select_existing_client') }}</label>
                                ...
                                @else
                                <div class="col-12">
                                    <label for="customer_name" class="form-label">{{ __('sales_views.customer_name') }}
                                        <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="customer_name" name="customer_name"
                                        required>
                                    <div class="invalid-feedback">{{ __('sales_views.please_enter_customer_name') }}
                                    </div>
                                </div>
                                <div class="col-12">
                                    <label for="customer_mobile" class="form-label">{{ __('sales_views.phone') }} <span
                                ...
                                <div class="col-12">
                                    <label for="customer_email" class="form-label">{{ __('sales_views.email') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="email" class="form-control" id="customer_email" name="customer_email"
                                        required>
                                    <div class="invalid-feedback">{{ __('sales_views.please_enter_valid_email_address')
                                        }}</div>
                                </div>
                                <div class="col-12">
                                    <label for="customer_address" class="form-label">{{ __('sales_views.address') }}
                                        <span class="text-danger">*</span></label>
                                ...
                                <div class="col-12">
                                    <label for="customer_city" class="form-label">{{ __('sales_views.city') }} <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-12">
                                    <label for="customer_zip_code" class="form-label">{{ __('sales_views.zip_code')
                                        }}</label>
                                ...
                                <div class="col-12">
                                    <label for="customer_tax_number" class="form-label">{{ __('sales_views.tax_number')
                                        }} <span class="text-danger">*</span></label>
                        ...
                        <div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select" id="equipment_type_id" name="equipment_type_id"
                                            required>
                                            <option value="">{{ __('sales_views.select_equipment_type') }}</option>
                                        ...
                                        <div class="invalid-feedback">{{ __('sales_views.please_select_equipment_type')
                                            }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        ...
                                        <div class="invalid-feedback">{{ __('sales_views.please_enter_equipment_model')
                                            }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" class="form-control" id="equipment_quantity"
                                            ...
                                            placeholder="{{ __('sales_views.enter_quantity') }}" required min="1">
                                        <label for="equipment_quantity">{{ __('sales_views.quantity') }} <i
                                                class="bx bx-info-circle tooltip-icon" data-bs-toggle="tooltip"
                                                title="{{ __('sales_views.quantity_tooltip') }}"></i></label>
                                        <div class="invalid-feedback">{{ __('sales_views.please_enter_valid_quantity')
                                            }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" class="form-control" id="warranty" name="warranty"
                                            placeholder="{{ __('sales_views.enter_warranty_period') }}" required min="0"
                                            value="0">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" id="equipment_description"
                                            name="equipment_description"
                                            placeholder="{{ __('sales_views.enter_description') }}"
                            ...
                            <div class="mt-3">
                                ...
                                <button type="button" class="btn btn-primary" onclick="handleNextStep()">{{
                                    __('sales_views.next') }}<i class='bx bx-right-arrow-alt ms-2'></i></button>
                            </div>
                        </div>
                        ...
                        <div id="test-l-3" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger3">
                            ...
                            <div id="branches-container">
                                ...
                                <div class="p-3 mb-4 rounded border branch-form" data-branch-index="0">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label for="branchName0" class="form-label">{{ __('sales_views.branch_name')
                                                }} <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="branchName0"
                                                name="branchName[0]" required>
                                            <div class="invalid-feedback">{{ __('sales_views.please_enter_branch_name')
                                                }}</div>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="branchmanager0" class="form-label">{{
                                                __('sales_views.branch_manager_name') }} <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="branchmanagerPhone0" class="form-label">{{
                                                __('sales_views.manager_phone') }} <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="invalid-feedback">{{ __('sales_views.please_select_branch_city')
                                                }}</div>
                                        </div>
                                        <div class="col-12">
                                            <label for="branchAddress0" class="form-label">{{ __('sales_views.address')
                                                }} <span class="text-danger">*</span></label>
                                            <textarea class="form-control" id="branchAddress0" name="branchAddress[0]"
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-lg-6">
                                    <label for="Contractamount" class="form-label">{{
                                        __('sales_views.contract_amount_without_vat') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="number" class="form-control" name="contractamount" id="Contractamount"
                                        x-model="contractAmount" required min="0" step="0.01">
                                    <div class="invalid-feedback">{{
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <select class="form-select" name="payment_type" id="payment_type"
                                        ...
                                        <option value="postpaid">{{ __('sales_views.postpaid_installments') }}</option>
                                    </select>
                                ...
                                <template x-if="payment_type === 'postpaid'">
                                    <div class="col-12 col-lg-6 postpaid-field">
                                        <label for="number_of_payments" class="form-label">{{
                                            __('sales_views.number_of_payments') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="number_of_payments"
                                            id="number_of_payments" x-model="numberOfPayments" required min="1"
                                            max="24">
                                        <div class="invalid-feedback">{{
                                ...
                                <template x-if="payment_type === 'postpaid'">
                                    <div class="col-12 col-lg-6 postpaid-field">
                                        <label for="payment_schedule" class="form-label">{{
                                            __('sales_views.payment_schedule') }} <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-12">
                                    <div class="alert alert-info">
                                        <div class="row">
                                            ...
                                            <div class="col-6">{{ __('sales_views.vat_percentage', ['percentage' =>
                                                '15']) }}:</div>
                                            <div class="col-6 text-end" x-text="'SAR ' + vatAmount.toFixed(2)"></div>
                                            <div class="col-6"><strong>{{ __('sales_views.total_amount') }}:</strong>
                                            </div>
                                            ...
                                            <template x-if="payment_type === 'postpaid'">
                                                <div class="mt-2 col-12">
                                                    <div class="row">
                                                        <div class="col-6">{{ __('sales_views.payment_per_installment')
                                                            }}:</div>
                                                        <div class="col-6 text-end"
                        ...
                        <div id="test-l-5" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger5">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <h6 class="mb-3">{{ __('sales_views.equipment_information') }}</h6>
                                                ...
                                                <div class="col-md-6">
                                                    <h6 class="mb-3">{{ __('sales_views.payment_information') }}</h6>
                                                    <table class="table table-borderless">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="mb-4 card-title">{{ __('sales_views.branch_information') }}</h5>
                                            <div class="row">
                                                <div class="col-md-12">
                            ...
                            <div class="mt-3">
                                <button type="button" class="btn btn-primary" onclick="handlePreviousStep()"><i
                                        class='bx bx-left-arrow-alt me-2'></i>{{ __('sales_views.previous') }}</button>
                                <button type="submit" class="btn btn-success"><i class='bx bx-check me-2'></i>{{ __('sales_views.submit_contract') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            if (branchSummary) {
                ...
                branches.forEach((branch, index) => {
                    ...
                    if (branchName?.value && branchManager?.value && branchManagerPhone?.value &&
                        ...
                        const cityText = '{{ __('sales_views.city') }}';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                `;
                    ...
                    branchForm.querySelector('.remove-branch-btn').addEventListener('click',
                        function() {
                            branchForm.remove();
                ...
                document.querySelector('.branch-form .remove-branch-btn').addEventListener('click',
                    function() {
