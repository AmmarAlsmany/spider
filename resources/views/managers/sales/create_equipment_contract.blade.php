                        ...
                        <form action="{{ route('equipment.contract.store') }}" method="POST" id="contractForm">
                                    ...
                                    @else
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="customer_mobile"
                                                ...
                                                required>
                                            <div class="invalid-feedback">Please enter a valid Saudi mobile number
                                                (05xxxxxxxx)</div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <label for="customer_address" class="form-label">Address <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12">
                                            <label for="customer_city" class="form-label">City <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12">
                                            <label for="customer_tax_number" class="form-label">Tax Number <span
                                                    class="text-danger">*</span></label>
                            ...
                            <div id="test-l-2" role="tabpanel" class="bs-stepper-pane"
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            ...
                                            <label for="equipment_type_id">Equipment Type <i
                                                    class="bx bx-info-circle tooltip-icon" data-bs-toggle="tooltip"
                                                    title="Select the type of equipment you wish to purchase"></i></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="equipment_model"
                                                name="equipment_model" placeholder="Enter model" required>
                                            <label for="equipment_model">Equipment Model <i
                                                    class="bx bx-info-circle tooltip-icon" data-bs-toggle="tooltip"
                                                    title="Enter the specific model of the equipment"></i></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="number" class="form-control" id="equipment_quantity"
                                                name="equipment_quantity" placeholder="Enter quantity" required
                                                min="1">
                                            <label for="equipment_quantity">Quantity <i
                                                    class="bx bx-info-circle tooltip-icon" data-bs-toggle="tooltip"
                                                    title="Enter the number of units you wish to purchase"></i></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="number" class="form-control" id="warranty" name="warranty"
                                                placeholder="Enter warranty period" required min="0"
                                                value="0">
                                            <label for="warranty">Warranty Period (Months) <i
                                                    class="bx bx-info-circle tooltip-icon" data-bs-toggle="tooltip"
                                                    title="Enter the warranty period in months"></i></label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            ...
                                            <label for="equipment_description">Description <i
                                                    class="bx bx-info-circle tooltip-icon" data-bs-toggle="tooltip"
                                                    title="Provide a detailed description of the equipment"></i></label>
                                ...
                                <div class="mt-3">
                                    ...
                                    <button type="button" class="btn btn-primary" onclick="handleNextStep()">Next<i
                            ...
                            <div id="test-l-3" role="tabpanel" class="bs-stepper-pane"
                                ...
                                <div id="branches-container">
                                    ...
                                    <div class="p-3 mb-4 rounded border branch-form" data-branch-index="0">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <label for="branchName0" class="form-label">Branch Name <span
                                                        class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-6">
                                                <label for="branchmanager0" class="form-label">Branch Manager Name <span
                                                        class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-6">
                                                <label for="branchmanagerPhone0" class="form-label">Manager Phone <span
                                                        class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-6">
                                                <label for="branchCity0" class="form-label">City <span
                                                        class="text-danger">*</span></label>
                                            ...
                                            <div class="col-12">
                                                <label for="branchAddress0" class="form-label">Address <span
                                                        class="text-danger">*</span></label>
                            ...
                            <div id="test-l-4" role="tabpanel" class="bs-stepper-pane"
                                ...
                                <div class="row g-3">
                                    <div class="col-12 col-lg-6">
                                        <label for="Contractamount" class="form-label">Contract Amount (without VAT) <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <template x-if="payment_type === 'postpaid'">
                                        <div class="col-12 col-lg-6 postpaid-field">
                                            <label for="number_of_payments" class="form-label">Number of Payments <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" class="form-control" name="number_of_payments"
                                                id="number_of_payments" x-model="numberOfPayments" required
                                                min="1" max="24">
                                            <div class="invalid-feedback">Please enter a valid number of payments (1-24)
                                            </div>
                                        </div>
                                    </template>
                            ...
                            <div id="test-l-5" role="tabpanel" class="bs-stepper-pane"
                                ...
                                <div class="mt-3">
                                    <button type="button" class="btn btn-primary" onclick="handlePreviousStep()"><i
                                            class='bx bx-left-arrow-alt me-2'></i>Previous</button>
                                    <button type="submit" class="btn btn-success"><i class='bx bx-check me-2'></i>Submit
                                        Contract</button>
                                </div>
                            </div>
                        </form>
