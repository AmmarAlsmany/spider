                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($branch->branch_address) }}" target="_blank" class="text-primary"><i class="bx bx-map me-1">{{ $branch->branch_address }}</i></a></td>
