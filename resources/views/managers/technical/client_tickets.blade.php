            ...
            <div class="table-responsive">
                <table class="table mb-0 align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#solveTicket{{ $ticket->id }}">
                                    <i class="bx bx-message-square-check"></i> Solve
                                </button>
                                @endif
                            </td>
                        </tr>
                        ...
                        <!-- Solve Ticket Modal -->
                        <div class="modal fade" id="solveTicket{{ $ticket->id }}" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Solve Ticket #{{ $ticket->tiket_number }}</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <form action="{{ route('technical.client_tickets.update_status', $ticket->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('POST')
                                        <div class="modal-body">
