        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Technical Manager Dashboard</h4>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="hover:bg-light">
                                        ...
                                        <td class="py-3">
                                            ...
                                            <span class="px-3 py-1 badge rounded-pill bg-warning-subtle text-warning">In
                                                Progress</span>
                                            @else
                                            <span
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="7" class="py-4 text-center text-muted">No schedules for today</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-sm">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($contract->visitSchedules->where('visit_date', '!=', \Carbon\Carbon::today()->toDateString()) as $visit)
                                                    <tr>
                                                        <td class="py-3">
                                                            <div class="text-wrap" style="max-width: 200px;">
