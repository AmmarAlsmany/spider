                                                ...
                                                @foreach ($todayBranchVisits as $branchId => $branch)
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link {{ $firstBranch ? 'active' : '' }}"
                                                            id="today-branch-{{ $branchId }}-tab" data-bs-toggle="tab"
                                                            ...
                                                            {{ $branch['name'] }}
                                                            <span
                                                                class="badge bg-primary ms-2">{{ count($branch['visits']) }}</span>
                                                        </button>
                                                    </li>
                                            ...
                                            <div class="tab-content" id="todayBranchTabsContent">
                                                ...
                                                @foreach ($todayBranchVisits as $branchId => $branch)
                                                    <div class="tab-pane fade {{ $firstBranch ? 'show active' : '' }}"
                                                        id="today-branch-{{ $branchId }}-content" role="tabpanel"
                                                        aria-labelledby="today-branch-{{ $branchId }}-tab">

                                                        <!-- Debug info -->
                                                        <div class="mb-2 alert alert-info">
                                                            <strong>Debug:</strong> This branch has
                                                            {{ count($branch['visits']) }} visit(s)
                                                            <br>
                                                            <strong>Visit IDs:</strong>
                                                            @foreach ($branch['visits'] as $debugVisit)
                                                                #{{ $debugVisit->id }} ({{ $debugVisit->visit_date }},
                                                                {{ $debugVisit->visit_time }}),
                                                            @endforeach
                                                        </div>
                                                                ...
                                                                <tbody>
                                                                    @forelse($branch['visits'] as $schedule)
                                                                        <tr class="hover:bg-light">
                                                                            <td class="py-3">{{ $schedule->visit_time }}
                                                                            </td>
                                                                            <td class="py-3">
                                                                            ...
                                                                            <td class="py-3">
                                                                                @if ($schedule->contract && $schedule->contract->customer)
                                                                                    <div class="fw-medium">
                                                                                        {{ $schedule->contract->customer->name }}
                                                                                    </div>
                                                                                @else
                                                                                    <span class="text-muted">N/A</span>
                                                                                @endif
                                                                            ...
                                                                            <td class="py-3">
                                                                                <span
                                                                                    class="badge bg-soft-info text-info">{{ $schedule->team->name }}</span>
                                                                            </td>
                                                                            <td class="py-3">
                                                                                @if ($schedule->status == 'scheduled')
                                                                                    <span
                                                                                        class="badge bg-soft-warning text-warning">Scheduled</span>
                                                                                @elseif($schedule->status == 'in_progress')
                                                                                    <span
                                                                                        class="badge bg-soft-primary text-primary">In
                                                                                        Progress</span>
                                                                                ...
                                                                                @elseif($schedule->status == 'cancelled')
                                                                                    <span
                                                                                        class="badge bg-soft-danger text-danger">Cancelled</span>
                                                                                @else
                                                                                    <span
                                                                                        class="badge bg-soft-secondary text-secondary">{{ $schedule->status }}</span>
                                                                                @endif
                                                                            </td>
                                                                            <td class="py-3">
                                                                                <div class="gap-2 d-flex">
                                                                                    @if ($schedule->status == 'scheduled')
                                                                                        <button type="button"
                                                                                            class="btn btn-sm btn-outline-primary edit-visit-btn"
                                                                                        ...
                                                                                        <form
                                                                                            action="{{ route('technical.appointment.cancel', $schedule->id) }}"
                                                                                            method="POST">
                                                                                            @csrf
                                                                                            @method('PUT')
                                                                                            <button type="submit"
                                                                    ...
                                                                    @empty
                                                                        <tr>
                                                                            <td colspan="6"
                                                                                class="py-4 text-center text-muted">No
                                                                                schedules for this branch today</td>
                                                                        </tr>
                                                                    @endforelse
                                                                </tbody>
                                                            </table>
                                                    ...
                                                    <h2 class="accordion-header" id="heading{{ $contract->id }}">
                                                        <button class="accordion-button collapsed" type="button"
                                                            ...
                                                            <div class="d-flex justify-content-between w-100">
                                                                ...
                                                                <span
                                                                    class="badge bg-primary">{{ $contract->visitSchedules->count() }}
                                                                    Upcoming Visits</span>
                                                            </div>
                                                        </button>
                                                    </h2>
                                                    <div id="collapse{{ $contract->id }}"
                                                        ...
                                                        <div class="accordion-body">
                                                            @php
                                                                ...
                                                                $upcomingVisits = $contract->visitSchedules->filter(
                                                                    function ($visit) use ($today) {
                                                                        return \Carbon\Carbon::parse($visit->visit_date)
                                                                            ->startOfDay()
                                                                            ->gt($today);
                                                                    },
                                                                );
                                                            ...
                                                            @if (count($contractBranchVisits) > 0)
                                                                ...
                                                                <ul class="mb-3 nav nav-tabs"
                                                                    id="contract-{{ $contract->id }}-branch-tabs"
                                                                    role="tablist">
                                                                    @php $firstBranch = true; @endphp
                                                                    @foreach ($contractBranchVisits as $branchId => $branch)
                                                                        <li class="nav-item" role="presentation">
                                                                            <button
                                                                                class="nav-link {{ $firstBranch ? 'active' : '' }}"
                                                                ...
                                                                <div class="tab-content"
                                                                    id="contract-{{ $contract->id }}-branch-tabs-content">
                                                                    @php $firstBranch = true; @endphp
                                                                    @foreach ($contractBranchVisits as $branchId => $branch)
                                                                        <div class="tab-pane fade {{ $firstBranch ? 'show active' : '' }}"
                                                                                    ...
                                                                                    <tbody>
                                                                                        @foreach ($branch['visits'] as $visit)
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="py-3">
                                                                                                    <span
                                                                                                        class="badge bg-soft-info text-info">{{ $visit->team->name }}</span>
                                                                                                </td>
                                                                                                <td class="py-3">
                                                                                                    ...
                                                                                                    @else
                                                                                                        <span
                                                                                                            class="badge bg-soft-secondary text-secondary">{{ $visit->status }}</span>
                                                                                                    @endif
                                                                                                </td>
                                                                                                <td class="py-3">
                                                                                                    <div
                                                                                                        ...
                                                                                                        @if ($visit->status == 'scheduled')
                                                                                                            ...
                                                                                                            <form
                                                                                                                action="{{ route('technical.appointment.cancel', $visit->id) }}"
                                                                                                                method="POST">
                                                                                                                @csrf
                                                                                                                @method('PUT')
                                                                                                                <button
                                                            ...
                                                            @else
                                                                <div class="py-3 text-center">
                                                                    <p class="text-muted">No upcoming visits for this
                                                                        contract</p>
                                                                </div>
                                                            @endif
                                                        </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="time" class="form-control" id="edit_visit_time" name="visit_time"
                                        required>
                                    <small class="form-text text-muted">Select a time between 8:00 AM and 4:00 PM (visits
                                        take 2
                                        hours)</small>
                                </div>
                                <div class="mb-3 form-group">
                        ...
                        <form id="rescheduleForm" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="date" class="form-control" id="new_visit_date" name="visit_date"
                                        required min="{{ date('Y-m-d', strtotime('today')) }}">
                                </div>

                                <div class="mb-3 form-group">
                                    <label for="new_visit_time">New Visit Time</label>
                                    <input type="time" class="form-control" id="new_visit_time" name="visit_time"
                                        required>
                                    <small class="form-text text-muted">Select a time between 8:00 AM and 4:00 PM (visits
                                        take 2 hours)</small>
                                </div>
