                                ...
                                <div class="overflow-hidden border-0 transition-all card rounded-4 hover:transform hover:scale-102"
                                    ...
                                    <div class="p-4 card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <p class="mb-1 text-sm font-medium text-muted">Pending Team Assignments
                                                </p>
                                                <h3 class="mb-0 fw-bold text-dark">{{ $pendingTeamAssignments ?? 0 }}
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="mb-3 nav nav-tabs" id="todayBranchTabs" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link {{ $firstBranch ? 'active' : '' }}"
                                                ...
                                                data-bs-target="#today-branch-{{ $branchId }}-content" type="button"
                                                role="tab" aria-controls="today-branch-{{ $branchId }}-content"
                                                aria-selected="{{ $firstBranch ? 'true' : 'false' }}">
                                                {{ $branch['name'] }}
                                                <span class="badge bg-primary ms-2">{{ count($branch['visits'])
                                                    }}</span>
                                            </button>
                                        </li>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table mb-0 table-centered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @empty
                                                        <tr>
                                                            <td colspan="6" class="py-4 text-center text-muted">No
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapse{{ $contract->id }}" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    @php
                                                    // Group upcoming visits by branch for this contract - with improved
                                                    // error handling
                                                    ...
                                                    <ul class="mb-3 nav nav-tabs"
                                                        id="contract-{{ $contract->id }}-branch-tabs" role="tablist">
                                                        @php $firstBranch = true; @endphp
                    ...
                    <form id="editForm" method="POST" action="">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <small class="form-text text-muted">Select a time between 8:00 AM and 8:00 PM (visits
                                    take 2
                                    hours)</small>
                            </div>
                            <div class="mb-3 form-group">
