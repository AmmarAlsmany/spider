                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <div class="mt-2 text-muted small">
                                                Completed {{ $data['completed_visits'] }} of {{ $data['total_visits'] }}
                                                visits
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="progress" style="height: 20px;">
                                                <div class="progress-bar bg-info" role="progressbar"
                                                    style="width: {{ $data['report_rate'] }}%;"
                                                    aria-valuenow="{{ $data['report_rate'] }}" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                    {{ $data['report_rate'] }}%
                                                </div>
                                            </div>
                                            <div class="mt-2 text-muted small">
                                                Submitted {{ $data['reports_created'] }} of
                                                {{ $data['completed_visits'] }} reports
                                            </div>
                                        </div>
                                    </div>
                                </div>
