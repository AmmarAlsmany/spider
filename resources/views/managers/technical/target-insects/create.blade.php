...
@section('title', 'Add New Target Insect')

@section('content')
<div class="page-content">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Add New Target Insect</h5>
            <a href="{{ route('technical.target-insects.index') }}" class="btn btn-secondary">
                <i class="bx bx-arrow-back me-1"></i> Back to List
            </a>
        </div>
        <div class="card-body">
            <form action="{{ route('technical.target-insects.store') }}" method="POST">
                @csrf
                ...
                <div class="text-end">
                    <button type="submit" class="btn btn-primary">
                        <i class="bx bx-save me-1"></i> Save Target Insect
                    </button>
                </div>
            </form>
        </div>
