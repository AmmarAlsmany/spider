            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="gap-3 d-flex align-items-center">
                    ...
                    <form action="{{ route('technical.team.schedules') }}" method="GET" class="gap-2 d-flex">
                        ...
                        @if(request()->hasAny(['month', 'year', 'date']))
                ...
                <div class="col-md-3">
                    <div class="text-white card bg-primary">
                        <div class="card-body">
                            ...
                            <h3 class="mb-0 card-text">{{ $teams->sum(function($team) {
                ...
                <div class="col-md-3">
                    <div class="text-white card bg-success">
                        <div class="card-body">
                            ...
                            <h3 class="mb-0 card-text">{{ $teams->sum(function($team) {
                                return $team->visitSchedules->where('visit_date', date('Y-m-d'))
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('todayBtn').addEventListener('click', function() {
            window.location.href = '{{ route("technical.team.schedules") }}?date=' + new Date().toISOString().split('T')[0];
        });
        ...
        document.getElementById('weekBtn').addEventListener('click', function() {
            ...
            window.location.href = `{{ route("technical.team.schedules") }}?start_date=${startOfWeek.toISOString().split('T')[0]}&end_date=${endOfWeek.toISOString().split('T')[0]}`;
        });

        document.getElementById('monthBtn').addEventListener('click', function() {
            const today = new Date();
            window.location.href = '{{ route("technical.team.schedules") }}?month=' + (today.getMonth() + 1) + '&year=' + today.getFullYear();
        });
    });
