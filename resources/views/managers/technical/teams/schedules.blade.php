    ...
    <div class="card radius-10">
        ...
        <div class="card-header">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <div class="mb-2 d-flex d-md-none justify-content-between">
                        <button class="btn btn-sm btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#filterCollapse" aria-expanded="false" aria-controls="filterCollapse">
                            <i class="bx bx-filter-alt me-1"></i> Show Filters
                        </button>

                        <div>
                            <div class="btn-group btn-group-sm" role="group">
                                <button type="button" class="btn btn-outline-primary" id="todayBtnMobile">Today</button>
                                <button type="button" class="btn btn-outline-primary" id="weekBtnMobile">Week</button>
                                <button type="button" class="btn btn-outline-primary" id="monthBtnMobile">Month</button>
                            </div>
                        </div>
                    </div>

                    <!-- Desktop filters -->
                    <div class="gap-3 d-none d-md-flex align-items-center">
                        ...
                        <form id="desktopFilterForm" action="{{ route('technical.team.schedules') }}" method="GET" class="gap-2 d-flex align-items-center">
                            ...
                            <a href="{{ route('technical.team.schedules') }}" class="btn btn-sm btn-secondary">Reset</a>
                            @endif
                        </form>
                    </div>

                    <!-- Mobile collapsed filters -->
                    <div class="mt-2 collapse d-md-none" id="filterCollapse">
                        <div class="p-2 card card-body bg-light">
                            <form action="{{ route('technical.team.schedules') }}" method="GET">
                                <div class="mb-2">
                                    <label class="mb-1 form-label small">Date Range</label>
                                    <div class="gap-2 d-flex">
                                        <div class="flex-grow-1">
                                            <input type="date" name="from_date" class="form-control form-control-sm" placeholder="From" value="{{ request('from_date') }}">
                                        </div>
                                        <div class="flex-grow-1">
                                            <input type="date" name="to_date" class="form-control form-control-sm" placeholder="To" value="{{ request('to_date') }}">
                                        </div>
                                    </div>
                                </div>

                                <div class="mb-2">
                                    <label class="mb-1 form-label small">Month/Year</label>
                                    <div class="row g-2">
                                        <div class="col-6">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    @if (request()->hasAny(['month', 'year', 'date', 'from_date', 'to_date']))
                                    <a href="{{ route('technical.team.schedules') }}" class="btn btn-sm btn-secondary">
                ...
                <div class="col-md-3">
                    <div class="text-white card bg-success">
                        <div class="card-body">
                            ...
                            <h3 class="mb-0 card-text">
                                {{ $teams->sum(function ($team) {
                                return $team->visitSchedules->where('visit_date', date('Y-m-d'))->where('status',
                                'completed')->count();
                                }) }}
                            </h3>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a
                                            href="{{ route('technical.contract.show', ['id' => $schedule->contract->id]) }}">{{
                                            $schedule->contract->contract_number }}</a>
                                    </td>
                                    <td>
                        ...
                        <div class="mt-3 d-flex justify-content-end">
                            {{ $team->paginatedSchedules->appends(['page_' . $team->id => request('page_' .
                            $team->id)])->links('pagination::bootstrap-4') }}
                        </div>
                    </div>
                    @else
